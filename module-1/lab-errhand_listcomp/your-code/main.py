...
vocales = ["a","e", "i", "o", "u"]
non_vowels = [i for i in teststring if i not in vocales]
print(novocales)
...
sentence = 'The quick brown fox jumped over the lazy dog'
vocales = ["a","e", "i", "o", "u"]
consonantes = [i for i in sentence if i not in vocales]
print(consonantes)
...
import os
os.chdir("/home/jorge/Escritorio/Ironhack/Ejercicios/datamad0620")
list= os.listdir()
print(list)
...
import random
random_lists = [random.sample(range(1, 101), 10) for i in range(4)]
print(random_lists)
...
flatten_list = [n for i in list_of_lists for n in i]
